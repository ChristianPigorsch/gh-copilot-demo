namespace albums_api.Models
{
    public record Album(int Id, string Title, string Artist, double Price, string Image_url)
    {
        public static List<Album> GetAll()
        {
            ...
            new Album(2, "Seven Revision Army", "The Blue-Green Stripes",2023, 13.99, "https://aka.ms/albums-containerappslogo"),
            new Album(3, "Scale It Up", "KEDA Club",2023, 13.99, "https://aka.ms/albums-kedalogo"),
            ...
            new Album(6, "Sweet Container O' Mine", "Guns N Probeses",2023, 14.99, "https://aka.ms/albums-containerappslogo")
         };
